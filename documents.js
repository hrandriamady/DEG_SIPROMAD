...
async function loadAllDocuments() {
    try {
        ...
        docs.forEach(doc => {
            ...
            // Colonne 0 : Document (sans le nom de fichier)
            ...
            row.insertCell(2).innerHTML = `<span class="badge ${statusClass}">${doc.status === "en_attente" ? "En attente" : (doc.status === "valide" ? "Validé" : "En validation")}</span>`;
            // Colonne 3 : Date
